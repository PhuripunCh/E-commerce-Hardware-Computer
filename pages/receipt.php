...
<body>
    <div class="col-sm-8"><br>
        ...
        $orderlist_sql = "SELECT * FROM orderlist WHERE List_ID = '" . $_SESSION["List_ID"] . "' ";
        ...
        <div class="printable-area"><br>
            ...
            <table border="1">
                ...
                <tbody>
                    ...
                    WHERE d.List_ID = '" . $_SESSION["List_ID"] . "'";
    ...
    document.getElementById("printBtn").addEventListener("click", function() {
        ...
        printWindow.document.write('<html><head><title>Print</title></head><body>' + printableArea +
            '</body></html>');
