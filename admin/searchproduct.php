...
<body>
    <div class="col-sm-10">
        <div style="display: flex;  align-items: center;">
            <h1 style="margin-left: 40px;">ผลลัพธ์การค้นหา</h1>
            ...
            <div style="display: flex; align-items: center; position: relative; margin-left: 570px; margin-top: 10px;">
                ...
                <form action="index_ad.php?C=1&D=12" method="POST">
                    <input type="text" id="searchproduct" name="searchproduct" class="custom-input2"
                        placeholder="ค้นหาสินค้า" style="margin-left: 10px; width: 290px;">
                    <button type="submit" class="btn btn-primary"
                        style="margin-left: 10px; margin-top: -10px;">ค้นหา</button>
                </form>
        ...
        <table>
            ...
            <tbody>
                ...
                if (isset($_POST['searchproduct'])) {
                    ...
                    $searchproduct = $_SESSION['searchproduct'];

                    $sql = "SELECT Pro_ID, Pro_Name, Pro_Price, Pro_Description,Pro_Amount, Pro_Image FROM product WHERE Pro_Name LIKE '%$searchproduct%'";
                    $result = mysqli_query($conn, $sql);
                ...
                <!-- Modal -->
                <!-- แก้ไข modal เพื่อให้สามารถแนบรูปได้ -->
