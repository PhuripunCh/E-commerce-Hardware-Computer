            ...
            <div style="margin-left: 40px;">
                ...
                <div style="margin-top: 10px; display: flex; align-items: center;">
                    ...
                    <form action="index_ad.php?C=1&D=14" method="post">
                        <input type="date" name="start_date" id="searchInput" class="custom-input2"
                            placeholder="วว/ดด/ปปปป" style="width: 290px; margin-right: 10px;">
                        ถึงวันที่
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row_address['Add_Address'] . ", จังหวัด" . $row_address['Add_Province'] . ", อำเภอ" . $row_address['Add_District'] . ", รหัสไปรษณีย์" . $row_address['Add_Zip_code']; ?>
                    </td>
                    <td><?php echo $row['Cus_tel']; ?></td>
                    <td><?php echo number_format($row['List_total']); ?></td>
                    <td><?php echo $row['List_date']; ?></td>
                    <td><?php
                                    // Check the List_status
