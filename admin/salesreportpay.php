        ...
        <div style="display: flex; align-items: center;">
            <div style="margin-left: 40px;">
                ...
                <div style="margin-top: 10px; display: flex; align-items: center;">
                    ...
                    ถึงวันที่
                    <input type="date" name="end_date" class="custom-input2" style="margin-left: 10px; width: 290px;"
                        required>
        ...
        <div class="pagination">
            <?php
                if ($current_page > 1) {
                    ...
                    echo "<li class='page-item'><a class='page-link' href='?page=$prevPage&C=1&D=5'>&#9664; ก่อนหน้า</a></li>";
                }
                ...
                for ($page = 1; $page <= $total_pages; $page++) {
                    if ($page == $current_page) {
                        ...
                        echo "<li class='page-item'><a class='page-link' href='?page=$page&C=1&D=5'>$page</a></li>";
                    }
                }

                if ($current_page < $total_pages) {
                    $nextPage = $current_page + 1;
                    echo "<li class='page-item'><a class='page-link' href='?page=$nextPage&C=1&D=5'>ต่อไป &#9654;</a></li>";
                }
            ?>
        </div>
    </div><br>
