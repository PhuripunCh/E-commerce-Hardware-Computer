...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2024 at 09:11 AM
...
--
-- Table structure for table `addresscus`
--

CREATE TABLE `addresscus` (
  `Add_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `Add_Province` varchar(50) NOT NULL,
  `Add_District` varchar(50) NOT NULL,
  `Add_Zip_code` int(7) NOT NULL,
  `Add_Address` text NOT NULL,
  `Cus_ID` int(11) NOT NULL,
  `Add_status` enum('DEFAULT','RESERVE','','') NOT NULL,
  `Add_Subdistrict` varchar(50) NOT NULL,
  `provinces_id` int(11) NOT NULL,
  `amphures_id` int(11) NOT NULL,
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `addresscus`
--

INSERT INTO `addresscus` (`Add_ID`, `Add_Province`, `Add_District`, `Add_Zip_code`, `Add_Address`, `Cus_ID`, `Add_status`, `Add_Subdistrict`, `provinces_id`, `amphures_id`, `id`) VALUES
(0000000001, 'ปทุมธานี', 'คลองหลวง', 12120, 'ฟหก', 5, 'RESERVE', 'คลองหก', 0, 0, 0),
(0000000003, 'ปทุมธานี', 'คลองหลวง', 12120, 'aaaaaaaaaaaaaaa', 5, 'DEFAULT', 'คลองหก', 5, 67, 130206),
(0000000005, 'ปทุมธานี', 'คลองหลวง', 12120, 'หอกดกด\r\n', 5, 'RESERVE', 'คลองหก', 0, 0, 0),
(0000000006, 'ปทุมธานี', 'คลองหลวง', 12120, 'ดฟกด', 5, 'RESERVE', 'คลองหก', 2, 55, 110407),
(0000000008, 'ปทุมธานี', 'คลองหลวง', 12120, 'หฟกฟหกหฟ', 5, 'RESERVE', 'คลองสาม', 4, 67, 130203),
(0000000009, 'นนทบุรี', 'บางกรวย', 11130, 'adasdasd', 54, 'DEFAULT', 'บางกรวย', 3, 59, 120202),
(0000000010, 'ปทุมธานี', 'คลองหลวง', 12120, 'Home', 1, 'DEFAULT', 'คลองหก', 4, 67, 130206),
(0000000011, 'สมุทรปราการ', 'พระประแดง', 10130, 'บ้าน', 1, 'RESERVE', 'สำโรง', 2, 55, 110414),
(0000000012, 'ปทุมธานี', 'คลองหลวง', 12120, 'บ้าน', 6, 'DEFAULT', 'คลองหก', 0, 0, 0),
(0000000013, 'สมุทรปราการ', 'พระประแดง', 10130, 'บ้านพัก', 6, 'RESERVE', 'สำโรง', 2, 55, 110414);
...
CREATE TABLE `amphures` (
  `amphures_id` int(5) NOT NULL,
  `code` varchar(4) NOT NULL,
  `amphures_name_th` varchar(150) NOT NULL,
  `name_en` varchar(150) NOT NULL,
  `provinces_id` int(5) NOT NULL DEFAULT 0
...
INSERT INTO `amphures` (`amphures_id`, `code`, `amphures_name_th`, `name_en`, `provinces_id`) VALUES
...
CREATE TABLE `category` (
  ...
  `Cate_qty` varchar(50) NOT NULL,
  `Cate_Icon` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `category` (`Cate_ID`, `Cate_Name`, `Cate_qty`, `Cate_Icon`) VALUES
(1, 'คีย์บอร์ด', '', 'keyboard.png'),
(2, 'เม้า', '', 'mouse.png'),
(3, 'ลำโพง', '', 'loud-speaker.png'),
(4, 'หูฟัง', '', 'headphones.png'),
(5, 'กล้อง', '', 'web-camera.png'),
(15, 'เก้าอี้เกมมิ่ง', '', 'chair.png'),
(18, 'อุปกรณ์อื่นๆ', '', 'responsive.png');
...
CREATE TABLE `customer` (
  ...
  `Cus_Password` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Cus_Email` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Cus_tel` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Cus_FName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Cus_LName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Cus_Status` enum('ADMIN','USER') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'USER'
...
INSERT INTO `customer` (`Cus_ID`, `Cus_Username`, `Cus_Password`, `Cus_Email`, `Cus_tel`, `Cus_FName`, `Cus_LName`, `Cus_Status`) VALUES
(00000000001, 'phuripun', 'pun123456', 'Pun123@gmail.com', '0863257830', 'Phuripunsdad', 'Chaichatchawal', 'USER'),
(00000000002, 'admin', 'admin', 'admin@gmail.com', '0891234567', 'admin', '1', 'ADMIN'),
(00000000005, 'natee', 'natee123', 'natee@gmail.com', '0123456789', 'natee', 'kompunthiong', 'USER'),
(00000000006, 'sirina', 'S12345678', 'Pun123@gmail.com', '1234567890', 'สิริณา', 'ช่วยเต็ม', 'USER'),
(00000000008, 'admin2', 'admin2', 'admin2@gmail.com', '1234567890', 'admin', '2', 'ADMIN');
...
CREATE TABLE `districts` (
  ...
  `name_en` varchar(150) NOT NULL,
  `amphures_id` int(11) NOT NULL DEFAULT 0
...
INSERT INTO `districts` (`id`, `zip_code`, `districts_name_th`, `name_en`, `amphures_id`) VALUES
...
INSERT INTO `orderdetail` (`Detail_ID`, `List_ID`, `Pro_ID`, `Detail_price`, `Detail_qty`, `Total`) VALUES
(1, 4, 1, 9000, 1, 9000),
(2, 4, 2, 4250, 1, 4250),
(3, 6, 3, 700, 1, 700),
(4, 7, 3, 700, 4, 2800),
...
(21, 21, 6, 9, 2, 18),
(22, 22, 1, 9000, 1, 9000),
(23, 23, 2, 4250, 3, 12750),
(24, 24, 2, 4250, 1, 4250),
(25, 26, 1, 9000, 1, 9000),
(26, 27, 1, 9000, 1, 9000),
(27, 28, 3, 700, 1, 700),
(28, 29, 3, 700, 6, 4200),
(29, 30, 1, 9000, 6, 54000),
(30, 31, 4, 1490, 1, 1490),
(31, 32, 2, 4250, 1, 4250),
(32, 33, 8, 9, 1, 9),
(33, 34, 6, 9, 1, 9),
(34, 35, 11, 4250, 1, 4250),
(35, 36, 35, 2000, 1, 2000),
(36, 38, 36, 2000, 1, 2000),
(37, 39, 5, 1111, 1, 1111),
(38, 40, 5, 1111, 1, 1111),
(39, 41, 5, 1111, 1, 1111),
(40, 42, 2, 4250, 1, 4250),
(41, 43, 4, 1490, 1, 1490),
(42, 44, 2, 4250, 4, 17000),
(43, 44, 4, 1490, 13, 19370),
(44, 45, 2, 4250, 1, 4250),
(45, 46, 1, 9000, 1, 9000),
(46, 47, 37, 200, 1, 200);
...
CREATE TABLE `orderlist` (
  `List_ID` int(11) UNSIGNED ZEROFILL NOT NULL,
  `Cus_ID` int(11) NOT NULL,
  `List_total` float(8,2) NOT NULL,
  `List_status` enum('PAY','NOTPAY','CANCEL') NOT NULL,
  `List_date` date NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `orderlist` (`List_ID`, `Cus_ID`, `List_total`, `List_status`, `List_date`, `Pay_img`, `shipping_type`) VALUES
(00000000001, 1, 4300.00, 'PAY', '2023-12-23', '', ''),
(00000000002, 1, 6300.00, 'PAY', '2023-12-22', '', ''),
(00000000003, 5, 1000.00, 'PAY', '2023-12-23', '', ''),
(00000000004, 1, 13250.00, 'PAY', '2023-12-24', 'logo.png', ''),
(00000000005, 5, 0.00, 'PAY', '2023-12-25', 'logo.png', ''),
(00000000006, 1, 700.00, 'PAY', '2023-12-26', 'mouse1.png', ''),
(00000000007, 5, 2800.00, 'PAY', '2023-12-27', 'bgimg1.jpg', ''),
(00000000008, 5, 13950.00, 'PAY', '2023-12-28', 'logo.png', ''),
(00000000009, 5, 4250.00, 'PAY', '2024-01-03', 'qr.png', ''),
(00000000010, 1, 4950.00, 'PAY', '2024-01-04', 'headset2.jpg', ''),
(00000000011, 1, 2100.00, 'PAY', '2024-01-05', 'reg.png', ''),
(00000000012, 1, 700.00, 'PAY', '2024-01-06', 'TheFast Gaming gear.png', ''),
(00000000013, 5, 18000.00, 'PAY', '2024-01-07', 'login.png', ''),
(00000000014, 5, 4250.00, 'PAY', '2024-01-08', 'login.png', ''),
(00000000015, 1, 700.00, 'PAY', '2024-01-09', 'reg.png', ''),
(00000000016, 5, 700.00, 'PAY', '2024-01-10', 'login.png', ''),
(00000000017, 1, 8500.00, 'PAY', '2024-01-06', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000018, 5, 4250.00, 'PAY', '2024-01-08', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000019, 1, 9000.00, 'PAY', '2024-01-10', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000020, 1, 9.00, 'PAY', '2024-01-11', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000021, 1, 138.00, 'PAY', '2024-01-12', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000022, 5, 9120.00, 'PAY', '2024-01-17', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000023, 1, 12870.00, 'PAY', '2024-01-23', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', ''),
(00000000024, 5, 4370.00, 'PAY', '2024-01-29', '', ''),
(00000000026, 1, 9120.00, 'PAY', '2024-02-01', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000027, 1, 9120.00, 'PAY', '2024-02-02', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000028, 1, 820.00, 'PAY', '2024-02-03', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งด่วน'),
(00000000029, 1, 4320.00, 'PAY', '2024-02-04', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000030, 1, 54120.00, 'PAY', '2024-02-05', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000031, 1, 1610.00, 'PAY', '2024-02-06', 'apps.png', ''),
(00000000032, 1, 4370.00, 'PAY', '2024-02-07', 'delivery.png', ''),
(00000000033, 1, 129.00, 'PAY', '2024-02-08', 'analysis.png', ''),
(00000000034, 1, 129.00, 'PAY', '2024-02-09', 'delivery.png', ''),
(00000000035, 1, 4370.00, 'PAY', '2024-02-10', '', ''),
(00000000036, 1, 2120.00, 'PAY', '2024-02-11', '', ''),
(00000000037, 1, 0.00, 'PAY', '2024-02-12', '', 'ส่งด่วน'),
(00000000038, 1, 2120.00, 'PAY', '2024-02-13', '', ''),
(00000000039, 1, 1231.00, 'PAY', '2024-02-14', '', ''),
(00000000040, 1, 1231.00, 'PAY', '2024-02-15', '', ''),
(00000000041, 1, 1231.00, 'PAY', '2024-02-16', '', ''),
(00000000042, 1, 4370.00, 'NOTPAY', '2024-02-02', '', ''),
(00000000043, 1, 1610.00, 'NOTPAY', '2024-02-02', '', ''),
(00000000044, 5, 36490.00, 'PAY', '2024-02-02', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000045, 1, 4370.00, 'NOTPAY', '2024-02-05', '', 'ส่งแบบปกติ'),
(00000000046, 1, 9120.00, 'NOTPAY', '2024-02-05', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ'),
(00000000047, 1, 320.00, 'NOTPAY', '2024-02-16', '9a58ef02-35e3-4ac5-85d2-d6d254722cad.jpg', 'ส่งแบบปกติ');
...
INSERT INTO `product` (`Pro_ID`, `Cate_ID`, `Pro_Name`, `Pro_Price`, `Pro_Description`, `Pro_Image`, `Pro_Amount`) VALUES
(1, 15, 'SIGNO E-Sport Gaming Chair BAROCK รุ่น GC-202', 9000.00, 'เบาะกว้างนั่งสบาย ราคาเบา ๆ สบายกระเป๋า\r\nโครงเหล็กแข็งแรงทนทาน 2D Armsets\r\nปรับเอนนอนได้180องศา\r\nปรับระดับสูงต่ำได้\r\nรองรับน้ำหนักได้150kgสบายๆ\r\nหนังทนเบาะนิ่ม เหมาะกับนั่งเป็นเวลานาน', 'Chair3.jpg', '6'),
(2, 15, ' เก้าอี้เล่นเกม Gaming Chair รุ่น NBCH007 Light Pi', 4250.00, 'ใช้หนัง PU เกรดสูง\r\nโฟมมีคุณสมบัติคืนตัว\r\nล้อขนาดมาตรฐาน\r\nปรับเอนได้ 180 องศา\r\nรองรับความสูง 160 - 190 เซนติเมตร\r\nรองรับน้ำหนักได้ถึง 150 กิโลกรัม\r\nพนักวางแขนปรับความสูงได้\r\nระยะการปรับความสูงกว้างรองรับผู้ใช้งานได้ทั่วถึง\r\nมีหมอนรองหลังและรองหัว', 'chair2.jpg', '0'),
(3, 2, 'Gaming Mouse เม้าส์เกมมิ่ง รุ่น HERACLES X53 ', 700.00, 'เกมมิ่งเม้าส์ 6 ปุ่ม พร้อมโปรแกรม\r\nเคลื่อนไหวรวดเร็วและแม่นยำด้วย PIXART PMW3325\r\nตั้งค่า DPI ได้ 400-5000 DPI (เมื่อใช้งานกับโปรแกรม สามารถตั้งค่าได้ถึง 10000 DPI)\r\nสามารถปรับ Polling Rate ได้ 125-250-500-1000 Hz\r\nHuano สวิตซ์ รองรับการคลิกได้ถึง 20 ล้านครั้ง\r\nออกแบบตามหลักสรีระศาสตร์ ใช้วัสดุเกรด Gaming Hi-End\r\nมีโหมดไฟสำหรับเล่นเกม\r\nชิปประมวลผล 32-bit ARM ที่ทำให้การทำงานของเมาส์ไหลลื่นไม่มีสะดุด', 'mouse1.png', '0'),
(4, 4, 'EGA TYPE H8 หูฟังเกมมิ่ง Gaming Headset เสียงเสมือ', 1490.00, 'มีไฟ RGB SPECTRUM   น้ำหนักเบา แข็งแรง\r\nระบบเสียงเสมือน 7.1 รอบทิศทาง \r\nไมโครโฟนคมชัด ปรับหมุนได้ 360 องศา\r\nมีสวิตต์  เพิ่ม/ลดเสียง\r\nสายคาดหัวปรับแต่งได้\r\nสวมใส่สบาย ไม่หนีบหู สามารถใช้งานได้เป็นเวลานาน\r\nเชื่อมต่อได้ผ่านพอร์ต USB 2.0 วัสดุทำจาก Gold plated\r\nมีโปรแกรม ปรับแต่งเสียง ดาวน์โหลดที่เว็ปไซต์ EGAZONE\r\nของแท้รับประกัน 2 ปี', 'headset1.jpg', '10'),
(5, 1, 'keyboard', 1111.00, 'asdasdasdasd', 'keyboard.jpg', '7'),
(6, 1, 'เก้าอี้เกมมิ่ง Nubwo CH-011 CH-007 รุ่นใหม่', 9.00, 'aadfsdafasdfsdaf', 'Chair3.jpg', '7'),
(7, 0, 'sssssssss', 9.00, 'asdasdasd', 'headset1.jpg', '9'),
(8, 0, 'เก้าอี้ Gamingฟกฟกห', 9.00, 'asdasdasd', 'Chair3.jpg', '9'),
(11, 0, 'SIGNO E-Sport Gaming Chair BAROCK รุ่น GC-202', 4250.00, 'zxczxczxc', 'mouse1.png', '4'),
(35, 4, 'หูฟังเกมมิ่ง', 2000.00, 'ฟหกฟหกฟหกฟหกฟหก', 'headset2.jpg', '8'),
(36, 4, 'asdasdsadasd', 2000.00, '', 'headset1.jpg', '4'),
(37, 3, 'ลำโพง', 200.00, '', 'loud-speaker.png', '8');
...
INSERT INTO `provinces` (`provinces_id`, `code`, `provinces_name_th`, `name_en`, `geography_id`) VALUES
...
CREATE TABLE `shipping` (
  ...
  `Ship_status` enum('PREPARE','SHIPPING','SUCCESS') NOT NULL,
  `Ship_tag` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `shipping` (`Ship_ID`, `Cus_ID`, `List_ID`, `Ship_date`, `Ship_status`, `Ship_tag`) VALUES
(1, 7, 6, '2024-01-03 14:42:00', 'SUCCESS', 'TH-123451231231'),
(2, 7, 9, '2024-01-06 17:04:00', 'PREPARE', ''),
(3, 32, 10, '2024-01-05 21:18:00', 'SUCCESS', 'TH-1234'),
(4, 32, 11, '2024-02-02 13:15:00', 'PREPARE', 'TH-1234'),
(5, 7, 12, '0000-00-00 00:00:00', 'PREPARE', ''),
(6, 34, 13, '2024-01-05 23:39:00', 'SHIPPING', 'TH-12345'),
(7, 34, 14, '0000-00-00 00:00:00', 'PREPARE', ''),
(8, 34, 15, '0000-00-00 00:00:00', 'PREPARE', ''),
(9, 34, 16, '0000-00-00 00:00:00', 'PREPARE', ''),
(10, 35, 17, '2024-01-06 09:23:00', 'SHIPPING', 'TH-12345'),
(11, 7, 18, '0000-00-00 00:00:00', 'PREPARE', ''),
(12, 7, 19, '0000-00-00 00:00:00', 'PREPARE', ''),
(13, 7, 20, '0000-00-00 00:00:00', 'PREPARE', ''),
(14, 7, 21, '0000-00-00 00:00:00', 'PREPARE', ''),
(15, 7, 22, '0000-00-00 00:00:00', 'PREPARE', ''),
(16, 1, 23, '0000-00-00 00:00:00', 'PREPARE', ''),
(17, 5, 24, '0000-00-00 00:00:00', 'PREPARE', ''),
(18, 1, 25, '0000-00-00 00:00:00', 'PREPARE', ''),
(19, 1, 26, '0000-00-00 00:00:00', 'PREPARE', ''),
(20, 1, 27, '0000-00-00 00:00:00', 'PREPARE', ''),
(21, 1, 28, '0000-00-00 00:00:00', 'PREPARE', ''),
(22, 1, 29, '0000-00-00 00:00:00', 'PREPARE', ''),
(23, 1, 30, '0000-00-00 00:00:00', 'PREPARE', ''),
(24, 1, 31, '0000-00-00 00:00:00', 'PREPARE', ''),
(25, 1, 32, '0000-00-00 00:00:00', 'PREPARE', ''),
(26, 1, 33, '0000-00-00 00:00:00', 'PREPARE', ''),
(27, 1, 34, '0000-00-00 00:00:00', 'PREPARE', ''),
(28, 1, 35, '0000-00-00 00:00:00', 'PREPARE', ''),
(29, 1, 36, '0000-00-00 00:00:00', 'PREPARE', ''),
(30, 1, 37, '0000-00-00 00:00:00', 'PREPARE', ''),
(31, 1, 38, '0000-00-00 00:00:00', 'PREPARE', ''),
(32, 1, 39, '0000-00-00 00:00:00', 'PREPARE', ''),
(33, 1, 40, '0000-00-00 00:00:00', 'PREPARE', ''),
(34, 1, 41, '0000-00-00 00:00:00', 'PREPARE', ''),
(35, 1, 42, '0000-00-00 00:00:00', 'PREPARE', ''),
(36, 1, 43, '0000-00-00 00:00:00', 'PREPARE', ''),
(37, 6, 44, '0000-00-00 00:00:00', 'PREPARE', ''),
(38, 1, 45, '0000-00-00 00:00:00', 'PREPARE', ''),
(39, 1, 46, '0000-00-00 00:00:00', 'PREPARE', ''),
(40, 1, 47, '0000-00-00 00:00:00', 'PREPARE', '');

-- --------------------------------------------------------

--
-- Table structure for table `sumproduct`
--

CREATE TABLE `sumproduct` (
  `Sum_ID` int(11) NOT NULL,
  `Pro_ID` int(11) NOT NULL,
  `Sum_qty` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `sumproduct`
--

INSERT INTO `sumproduct` (`Sum_ID`, `Pro_ID`, `Sum_qty`) VALUES
(1, 3, '3'),
(2, 3, '1'),
(3, 1, '2'),
(4, 2, '1'),
...
--
-- Indexes for table `addresscus`
--
ALTER TABLE `addresscus`
...
--
-- Indexes for table `sumproduct`
--
ALTER TABLE `sumproduct`
...
--
-- AUTO_INCREMENT for table `addresscus`
--
ALTER TABLE `addresscus`
  MODIFY `Add_ID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `amphures`
--
ALTER TABLE `amphures`
  MODIFY `amphures_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1007;
...
--
ALTER TABLE `customer`
  MODIFY `Cus_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `orderlist`
  MODIFY `List_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `shipping`
  MODIFY `Ship_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `sumproduct`
--
ALTER TABLE `sumproduct`
  MODIFY `Sum_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
COMMIT;
